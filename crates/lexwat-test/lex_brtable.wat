;; lex_brtable.wat — identical behavior and design to lex.wat, but the per-token
;; dispatch uses a 128-entry class table + `br_table` jump instead of a linear
;; chain of `i32.eq` comparisons. Used to measure the effect of the dispatch
;; strategy on performance. Everything else (buffer, get, trivia, keyword table,
;; number lexing, UTF-8 char handling) is the same as lex.wat.
...
(module
  ...
  ;; Keyword table at offset 0 (see lex.wat): [len][id][bytes...], 0-terminated.
  (data (i32.const 0)
  ...
  ;; Dispatch class per ASCII byte (offset 256). 0=invalid, 1=single-char punct,
  ;; 2='!' 3=':' 4='<' 5='=' 6='>' 7='-' 8=alpha 9=digit 10='\'' 11='"'.
  (data (i32.const 256)
    "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\0b\00\00\01\01\0a\01\01\01\01\01\07\01\01\09\09\09\09\09\09\09\09\09\09\03\01\04\05\06\00\00\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\01\00\01\01\08\00\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\08\01\01\01\00\00")

  ;; Token id for single-char punctuation (offset 384), 0 elsewhere.
  (data (i32.const 384)
    "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\03\00\04\05\06\07\08\00\0a\0b\00\00\00\00\00\00\00\00\00\00\00\0d\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\11\00\12\13\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\15\16\00\00")
  ...
  (func $next_token (export "next_token") (result i32)
    (local $c i32) (local $c1 i32) (local $i i32) (local $d i32) (local $e i32) (local $n i32) (local $cls i32)

    (call $skip_trivia)
    (local.set $c (call $get (global.get $pos)))
    (if (i32.lt_s (local.get $c) (i32.const 0)) (then (return (i32.const 0))))   ;; Eof
    (if (i32.gt_u (local.get $c) (i32.const 127)) (then (return (i32.const -1))))  ;; non-ASCII start
    (local.set $c1 (call $get (i32.add (global.get $pos) (i32.const 1))))
    (local.set $cls (i32.load8_u (i32.add (i32.const 256) (local.get $c))))

    (block $b11 (block $b10 (block $b9 (block $b8 (block $b7 (block $b6 (block $b5 (block $b4 (block $b3 (block $b2 (block $b1 (block $b0
      (br_table $b0 $b1 $b2 $b3 $b4 $b5 $b6 $b7 $b8 $b9 $b10 $b11 $b0 (local.get $cls)))
      ;; b0: invalid
      (return (i32.const -1)))
      ;; b1: single-char punctuation (id from table at 384)
      (global.set $pos (i32.add (global.get $pos) (i32.const 1)))
      (return (i32.load8_u (i32.add (i32.const 384) (local.get $c)))))
      ;; b2: '!' / '!='
      ...
      (global.set $pos (local.get $i))
      (return (local.get $c)))
      ;; b9: number (unsigned position)
      (return (call $lex_number (i32.const 0))))
      ;; b10: char literal
