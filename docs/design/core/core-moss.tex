...
invariant is what surfaced the repairs below. The theorem's empirical
...
leans on.
(vii)~$\This$ is \emph{reserved}: nothing else stopped a program from
...
condition.  Two of the findings above, (i) and (ii), name
configurations that surface Moss can plausibly express; whether the
bootstrap rejects them is an open question the design record should
answer.
