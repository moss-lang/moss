...
(revision 9, repository commit \texttt{61a5c68}), into a core calculus.
Decision tags such as [D1] refer to entries in that log. The metatheory of
\S\ref{sec:meta} is stated and believed, but has not been mechanized.}}
\date{July 28, 2026}
...
weakening lemma for $\delta \circ \varsigma$; it has not been
machine-checked. Its empirical counterpart is blunter: the self-hosted
compiler elaborates and runs its own 19-module source under exactly
these rules, to a byte-identical fixpoint.
